...
const FEATURES: FeatureRow[] = [
  ...
  {
    categoryId: 'hack-ability',
    id: 'battalion-size-5000-i',
    name: 'Battalion Size +5,000 I',
    description: 'Increase maximum troops per battalion from 15,000 to 20,000.',
    unlockCost: 18000000,
    levelRequirement: 54,
    researchTimeHours: 31.5,
    requiredFeatureRefs: [{ categoryId: 'hack-ability', featureId: 'battalion-size-6500' }],
    researchCenterLevelRequirement: 12,
    effect: { type: 'improvement', value: 5000, target: 'battalion-size' },
  },
  {
    categoryId: 'hack-ability',
    id: 'battalion-size-5000-ii',
    name: 'Battalion Size +5,000 II',
    description: 'Increase maximum troops per battalion from 20,000 to 25,000.',
    unlockCost: 26500000,
    levelRequirement: 71,
  ...
  {
    categoryId: 'hack-ability',
    id: 'battalion-size-7500-i',
    name: 'Battalion Size +7,500 I',
    description: 'Increase maximum troops per battalion from 25,000 to 32,500.',
    unlockCost: 34500000,
    levelRequirement: 87,
    researchTimeHours: 48,
    requiredFeatureRefs: [{ categoryId: 'hack-ability', featureId: 'battalion-size-5000-ii' }],
    researchCenterLevelRequirement: 16,
    effect: { type: 'improvement', value: 7500, target: 'battalion-size' },
  },
  {
    categoryId: 'hack-ability',
    id: 'battalion-size-7500-ii',
    name: 'Battalion Size +7,500 II',
    description: 'Increase maximum troops per battalion from 32,500 to 40,000.',
    unlockCost: 42500000,
    levelRequirement: 99,
    researchTimeHours: 56,
    requiredFeatureRefs: [{ categoryId: 'hack-ability', featureId: 'battalion-size-7500-i' }],
    researchCenterLevelRequirement: 18,
    effect: { type: 'improvement', value: 7500, target: 'battalion-size' },
  },
  {
    categoryId: 'hack-ability',
    id: 'battalion-size-10000',
    name: 'Battalion Size +10,000',
    description: 'Increase maximum troops per battalion from 40,000 to 50,000.',
    unlockCost: 50500000,
    levelRequirement: 99,
    researchTimeHours: 64,
    requiredFeatureRefs: [{ categoryId: 'hack-ability', featureId: 'battalion-size-7500-ii' }],
    researchCenterLevelRequirement: 20,
    effect: { type: 'improvement', value: 10000, target: 'battalion-size' },
  },
  {
    categoryId: 'investments',
