/**
 * Authoritative march distance and pace (seconds per DU from army composition); see taskItems/ios/hackMap/battles/map-hack-travel-async-battles.md and taskItems/historical-actions.md § Map hack.
 */
 ...
 * @see taskItems/ios/hackMap/battles/map-hack-travel-async-battles.md — march distance & travel time
 */
