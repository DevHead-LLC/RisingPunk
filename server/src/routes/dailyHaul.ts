...
/** Display only: tiers to show as x-ed off = calendar days that passed (never reduced by claiming). Marks top N from 7 down: 7, 6, 5, … so missed UTC days stay x-ed out after collecting a pull. Claim eligibility uses missedOpportunities in getNextClaimDayNum so consistent claimers can still reach day 7. */
