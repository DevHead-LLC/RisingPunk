...
/** Room remodel levels 2–8. +5 min per level. Garage add from level 5+. minPropertyLevel: roomLevel+1. */
export const RENTAL_ROOM_REMODEL_LEVELS: IRoomRemodelLevel[] = [
  { roomLevel: 2, constructionTimeMinutes: 5, cost: 5_000, minPropertyLevel: 3, addRates: { bathroom: 0.005, bedroom: 0.01, livingRoom: 0.01, kitchen: 0.005 } },
  { roomLevel: 3, constructionTimeMinutes: 10, cost: 10_000, minPropertyLevel: 4, addRates: { bathroom: 0.01, bedroom: 0.02, livingRoom: 0.02, kitchen: 0.01 } },
  { roomLevel: 4, constructionTimeMinutes: 15, cost: 15_000, minPropertyLevel: 5, addRates: { bathroom: 0.015, bedroom: 0.03, livingRoom: 0.03, kitchen: 0.015 } },
  { roomLevel: 5, constructionTimeMinutes: 20, cost: 20_000, minPropertyLevel: 6, addRates: { bathroom: 0.02, bedroom: 0.04, livingRoom: 0.04, kitchen: 0.02, garage: 0.005 } },
  { roomLevel: 6, constructionTimeMinutes: 25, cost: 25_000, minPropertyLevel: 7, addRates: { bathroom: 0.025, bedroom: 0.05, livingRoom: 0.05, kitchen: 0.025, garage: 0.01 } },
  { roomLevel: 7, constructionTimeMinutes: 30, cost: 30_000, minPropertyLevel: 8, addRates: { bathroom: 0.03, bedroom: 0.06, livingRoom: 0.06, kitchen: 0.03, garage: 0.015 } },
  { roomLevel: 8, constructionTimeMinutes: 35, cost: 35_000, minPropertyLevel: 9, addRates: { bathroom: 0.035, bedroom: 0.07, livingRoom: 0.07, kitchen: 0.035, garage: 0.02 } },
];
