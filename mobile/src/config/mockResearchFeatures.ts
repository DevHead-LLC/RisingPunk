...
export const MOCK_RESEARCH_FEATURES: Record<string, ResearchFeature[]> = {
  'home-defense': [
    {
      id: 'antivirus',
      name: 'Unlock Antivirus',
      description: 'Gain access to antivirus software to protect your systems from malware and cyber attacks. This provides a basic layer of defense for your digital infrastructure.',
      unlockCost: 5000,
      levelRequirement: 2,
      isUnlocked: false,
      effect: {
    ...
    },
    {
      id: 'bot-trap',
      name: 'Bot Trap',
      description: 'Instantly destroy 100 enemy bots in battle. This powerful defensive mechanism can turn the tide of battle when you\'re overwhelmed.',
      unlockCost: 15000,
      levelRequirement: 5,
      isUnlocked: false,
      effect: {
  ...
  'hack-ability': [
    {
      ...
      description: 'Increase the number of battalions you can deploy in a single battle. More battalions mean more strategic options and firepower.',
      unlockCost: 10000,
      levelRequirement: 3,
      isUnlocked: false,
      effect: {
    ...
    },
    {
      id: 'starting-node',
      name: 'Starting Node',
      description: 'Choose your starting position on the battle grid. Strategic positioning can give you a significant advantage in battle.',
      unlockCost: 8000,
      levelRequirement: 4,
      isUnlocked: false,
      effect: {
    ...
    },
    {
      ...
      description: 'Increase the number of troops in each battalion. Larger battalions can overwhelm smaller enemy forces.',
      unlockCost: 12000,
      levelRequirement: 5,
      isUnlocked: false,
      effect: {
    ...
    },
    {
      id: 'attack-boost',
      name: 'Attack Boost',
      description: 'Increase attack power for all bots in battalions. Higher attack values mean faster enemy elimination.',
      unlockCost: 18000,
      levelRequirement: 7,
      isUnlocked: false,
      effect: {
    ...
    },
    {
      id: 'defense-boost',
      name: 'Defense Boost',
      description: 'Increase defense power for all bots in battalions. Better defense means your bots survive longer in battle.',
      unlockCost: 18000,
      levelRequirement: 7,
      isUnlocked: false,
      effect: {
  ...
  'financial': [
    {
      id: 'improve-income',
      name: 'Improve Income',
      description: 'Increase your passive income generation rate. This provides a steady stream of funds for future investments and upgrades.',
      unlockCost: 12000,
      levelRequirement: 4,
      isUnlocked: false,
      effect: {
    ...
    },
    {
      id: 'reduce-debt',
      name: 'Reduce Debt',
      description: 'Lower interest rates on any outstanding debts. This reduces your financial burden and frees up more capital.',
      unlockCost: 18000,
      levelRequirement: 6,
      isUnlocked: false,
      effect: {
    ...
    },
    {
      ...
      description: 'Gain access to rental property investment opportunities. Rental income can provide a significant boost to your finances.',
      unlockCost: 25000,
      levelRequirement: 8,
      isUnlocked: false,
      effect: {
    ...
    },
    {
      ...
      description: 'Lower your daily operational costs. This increases your profit margins and available capital.',
      unlockCost: 15000,
      levelRequirement: 5,
      isUnlocked: false,
      effect: {
  ...
  'hack-crew': [
    {
      id: 'start-crew-unlock',
      name: 'Start Crew Unlock',
      description: 'Unlock the ability to form and manage hack crews',
      unlockCost: 40000,
      levelRequirement: 15,
      isUnlocked: false,
      effect: {
...
export function getMockResearchFeatures(categoryId: string): ResearchFeature[] {
  return MOCK_RESEARCH_FEATURES[categoryId] || [];
}
