...
const BACKGROUND_IMAGE_MAP: Record<string, ImageSourcePropType> = {
  ...
  'battalion-size-5000-i': require('../../assets/images/researchCenter/increaseBots250.png'),
  'battalion-size-5000-ii': require('../../assets/images/researchCenter/increaseBots250.png'),
  'battalion-size-7500-i': require('../../assets/images/researchCenter/increaseBots250.png'),
  'battalion-size-7500-ii': require('../../assets/images/researchCenter/increaseBots250.png'),
  'battalion-size-10000': require('../../assets/images/researchCenter/increaseBots250.png'),
  ...
  'reduce-utilities-05': require('../../assets/images/researchCenter/utilityExpenseReduction.png'),
  'reduce-misc-entertainment-10': require('../../assets/images/researchCenter/miscEntExpenseReduction.png'),
