...
export function FeatureModal({
  ...
  const { data: huntingFeatures, isLoading: huntingLoading } = useGetUserFeaturesQuery('hunting', { skip: !visible || !refCategories.includes('hunting') });
  ...
  const featuresByCategory = useMemo(() => ({
    ...
    'hunting': huntingFeatures?.features ?? [],
  ...
  const loadingByCategory = useMemo(() => ({
    ...
    'hunting': huntingLoading,
  }), [homeDefLoading, cashFlowLoading, hackAbilityLoading, hackCrewLoading, investmentsLoading, huntingLoading]);
