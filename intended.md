...
- `mobile/src/components/battle/BattleScoreBreakdown.tsx` - Detailed score breakdown by battalion
- `mobile/src/components/battle/BattalionLossDisplay.tsx` - Individual battalion loss display
- `mobile/src/components/battle/WinnerIndicator.tsx` - Winner determination and display
